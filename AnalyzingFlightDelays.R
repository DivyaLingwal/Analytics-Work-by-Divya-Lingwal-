...
del <- read.csv("D:/UniversityData/Allstdydata/slearn/Projects_for_R2/Data Science Project_4/Data Science Project_Regression/FlightDelays.csv")
del[1:3,]
...
## cumulative 1s sorted by predicted values
## cumulative 1s using the average success prob from evaluation set
axis=dim(n2)
ax=dim(n2)
ay=dim(n2)
axis[1]=1
